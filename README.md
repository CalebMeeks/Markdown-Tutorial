...
### Summary: Teaching Markdown features by coding Markdown pages provides me the oppurtunity to show the features of Markdown through both direct and indirect teaching. For example my use of links and headings are indirect teachings. However, I have certain pages dedicated to the direct teachings of things such as **bolding**, *italicizing*, or ~~striking through~~ words. If their are any questions as to how I did something, then students can look at the raw versions of these pages and see the code for themselves. I hope that the project can be used by future students to help give them a plethora of examples of what Markdown can do and how they can use it.
